...
export const portfolioData: PortfolioData = {
  intro: {
    ...
    bio: "I'm a Full-Stack Developer mastering to scalable innovation in software products. As an active AI enthusiast, I specialize in leveraging Generative AI, Agentic AI and Data Science to supercharge digital platforms, transforming complex problems into fast, seamless user experiences.",
