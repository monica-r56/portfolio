...
import { ArrowDown, ArrowRight, Trophy, BookOpen, Users, Mic, Sparkles } from "lucide-react";
...
const credIcons = [Trophy, BookOpen, Users, Mic, Sparkles];
const credAccents = [
...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Ambient blobs */}
      <div
        className="ambient-blob absolute -top-24 -right-32 w-[600px] h-[600px] opacity-[0.07]"
        style={{ background: "radial-gradient(circle, #5B7CFF 0%, #8B6DFF 50%, transparent 70%)" }}
      />
      <div
        className="ambient-blob absolute bottom-0 -left-32 w-[500px] h-[500px] opacity-[0.05]"
        style={{ background: "radial-gradient(circle, #42C7D9 0%, transparent 70%)" }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-[1fr_420px] gap-12 lg:gap-16 items-center min-h-[calc(100vh-72px)] py-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            {/* Headline */}
            <h1 className="stagger-1 text-[clamp(2.4rem,5.5vw,4.2rem)] font-bold leading-[1.06] tracking-[-0.02em] text-[#17171A] mb-6">
              I Build AI That <br className="hidden sm:block" />
              <span className="gradient-text-blue-violet">Moves Beyond </span>
          ...
          <div className="relative flex justify-center lg:justify-end">
            ...
            >
              {/* Glass morphic frame offset */}
              <div className="absolute inset-0 translate-x-3 translate-y-3 rounded-2xl backdrop-blur-md bg-gradient-to-br from-[#5B7CFF]/20 to-[#8B6DFF]/20 border-2 border-white/50 shadow-[0_8px_32px_rgba(91,124,255,0.15)]" />

              {/* Portrait */}
              <div className="relative rounded-2xl overflow-hidden bg-[#F0F0ED] w-full h-full border-2 border-white/60 backdrop-blur-sm shadow-[0_12px_40px_rgba(23,23,26,0.12)]">
                <img
                  src={PROFILE_IMG}
              ...
              {/* Floating metadata chip - glass morphic */}
              <div className="absolute -bottom-5 -left-6 bg-white/60 backdrop-blur-xl border border-white/50 rounded-xl px-4 py-3 shadow-[0_8px_32px_rgba(23,23,26,0.08)]">
                ...
                <p className="text-xs text-[#6B6B73] mt-0.5">Autodesk</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="relative z-10 w-full">
        <div className="bg-gradient-to-r from-[#17171A] via-[#1a1a2e] to-[#17171A] border-t border-[#5B7CFF]/20">
